...
{
{ SUNNY   ,HIGH_TEMPERATURE,HIGH_HUMIDITY,FALSE,NOT_PLAY,NULL },
{ SUNNY   ,HIGH_TEMPERATURE,HIGH_HUMIDITY,TRUE ,NOT_PLAY,NULL },
{ VOERCAST,HIGH_TEMPERATURE,NORMAL_HUMIDITY,FALSE,CAN_PLAY,NULL },
{ RAIN    ,MID_TEMPERATURE,HIGH_HUMIDITY,FALSE,CAN_PLAY,NULL },
{ RAIN    ,COLD_TEMPERATURE,NORMAL_HUMIDITY,FALSE,CAN_PLAY,NULL },
{ RAIN    ,COLD_TEMPERATURE,NORMAL_HUMIDITY,TRUE ,NOT_PLAY,NULL },
{ VOERCAST,COLD_TEMPERATURE,NORMAL_HUMIDITY,TRUE ,CAN_PLAY,NULL },
{ SUNNY   ,MID_TEMPERATURE,HIGH_HUMIDITY,FALSE,NOT_PLAY,NULL },
{ SUNNY   ,COLD_TEMPERATURE,NORMAL_HUMIDITY,FALSE,CAN_PLAY,NULL },
{ RAIN    ,MID_TEMPERATURE,NORMAL_HUMIDITY,FALSE,CAN_PLAY,NULL },
{ SUNNY   ,MID_TEMPERATURE,NORMAL_HUMIDITY,TRUE ,CAN_PLAY,NULL },
{ VOERCAST,MID_TEMPERATURE,HIGH_HUMIDITY,TRUE ,CAN_PLAY,NULL },
{ VOERCAST,HIGH_TEMPERATURE,NORMAL_HUMIDITY,FALSE,CAN_PLAY,NULL },
{ RAIN    ,MID_TEMPERATURE,NORMAL_HUMIDITY,TRUE ,NOT_PLAY,NULL }
};
//非类集合和类集合
